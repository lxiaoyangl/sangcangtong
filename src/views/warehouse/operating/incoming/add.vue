        ...
        <BasisDetail>
            ...
            <div slot="detail_content_form">
                <el-form ref="application_form" :model="form" :rules="form_rules" :inline="true" label-width="120px">
                    ...
                    <el-form-item label="入库方式" prop="inp2">
                        <el-select clearable v-model="form.inp2" placeholder="请选择入库方式" size="mini">
                            <el-option
                    ...
                    <el-form-item label="计划到园时间" prop="inp3">
                        <el-date-picker
                            v-model="form.inp3"
                            type="datetime"
                            placeholder="选择日期时间"
                    ...
                    <el-form-item label="货运联系人" prop="inp4">
                        <el-input v-model="form.inp4" placeholder="货运联系人" size="mini"></el-input>
                    </el-form-item>

                    <el-form-item label="货运联系方式" prop="inp5">
                        <el-input v-model="form.inp5" placeholder="货运联系方式" size="mini"></el-input>
                    </el-form-item>

                    <el-form-item label="交易订单号" prop="inp6">
                        <el-input v-model="form.inp6" placeholder="交易订单号" size="mini"></el-input>
                    </el-form-item>

                    <el-form-item label="装车点" prop="inp7">
                        <el-input v-model="form.inp7" placeholder="装车点" size="mini"></el-input>
                    </el-form-item>

                    <el-form-item label="卸车点" prop="inp8">
                        <el-input v-model="form.inp8" placeholder="卸车点" size="mini"></el-input>
                    </el-form-item>

                    <el-form-item label="装车地址" prop="inp9">
                        <el-input v-model="form.inp9" placeholder="装车地址" size="mini"></el-input>
                    </el-form-item>

                    <el-form-item label="联系人" prop="inp10">
                        <el-input v-model="form.inp10" placeholder="联系人" size="mini"></el-input>
                    </el-form-item>
